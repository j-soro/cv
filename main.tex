...
\begin{minipage}[t]{0.45\textwidth} % 45% of the page width for name
	...
	\colorbox{white}{{\HUGE\textcolor{black}{\textbf{\MakeUppercase{Joaquín}}}}} % First name
	
	\colorbox{white}{{\huge\textcolor{black}{\textbf{\MakeUppercase{Soro Castelló}}}}} % Last name	
	\vspace{6pt}
...
\cvsect{Experience (older to newer)}
...
\cvsect{Education (newer to older)}
